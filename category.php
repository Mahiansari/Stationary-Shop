...
$category = $_GET['cat'];
$product_query = "SELECT * FROM `product` WHERE ProductName like '%$category%'";
                ...
                <div class="flex flex-wrap -m-4">
                    <?php while ($row = mysqli_fetch_assoc($product_data)) { ?>
                        ...
                        <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                                <a href="Product_detail_page.php?pro_id=<?php echo $row['ProductID'] ?>" class="block relative h-48 rounded overflow-hidden">
                                    <img alt="ecommerce" class="object-cover object-center w-full h-full block" style="width: 100%;" src="admin/img/product images/<?php echo $row['ProductImageName'] ?>">
                                </a>
                                <div class="mt-4">
                                    <h2 class="text-gray-900 title-font text-lg font-large cen" style="align-items: center; justify-content: center;" ><?php echo $row['ProductName'] ?></h2>
                                    <p class="mt-1 cen">Rs : <?php echo $row['ProductPrice'] ?></p>
                                    <h3 class="text-gray-500 text-xs tracking-widest title-font mb-1 cen">id : <?php echo $row['ProductCode'] . $row['ProductNumber'] ?></h3>
                                    <form action="manage_cart.php" method="POST">
                                        ...
                                        <button class="atcb" name="Add_To_Cart" type="submit">Add to Cart</button>
                                    </form>
