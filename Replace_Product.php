...
if(isset($_POST['Replace'])){
    $user_product_id = $_GET['replace_pro'];
    $item_name = $_POST['Item_Name'];
    $item_price = $_POST['Price'];
    $replace_product_query = "UPDATE user_orders
    SET Item_Name = '$item_name', Price = '$item_price'
    WHERE user_orders = '$user_product_id';";
    mysqli_query($conn,$replace_product_query);
    echo "<script>
    alert('Order Replaced');
    window.location.href='Cust_order.php';</script>";
}
?>
                            ...
                            <div class="lg:w-1/4 md:w-1/2 p-4 w-full">
                                ...
                                <div class="mt-4">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <button class="atcb" name="Replace" type="submit">Replace</button>
                                    </form>
